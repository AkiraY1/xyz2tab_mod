...
df1.loc[df1.shape[0]] = ["", "", "", "", ""]
df1.to_csv(csv_output_file, mode="w", index=False, header=['Element','Atom count','Mass fraction /%', 'Cov. radius /A', 'Cov. radius + /A'])
...
df2 = pd.DataFrame(pr_sel_dist)
df2.loc[df2.shape[0]] = ["", ""]
df2.to_csv(csv_output_file, mode="a", index=False, header=['Atoms','Bond length /A'])
...
if args.verbose:
	...
	df3 = pd.DataFrame(summary_bond_table_1)
	df3.loc[df3.shape[0]] = ["", ""]
	df3.to_csv(csv_output_file, mode="a", index=False, header=['Atoms','Bond lengths /A'])
...
df4 = pd.DataFrame(summary_bond_table_2)
df4.loc[df4.shape[0]] = ["", ""]
df4.to_csv(csv_output_file, mode="a", index=False, header=['Atoms','Bond lengths /A'])
...
df5 = pd.DataFrame(summary_bond_table_3)
df5.loc[df5.shape[0]] = ["", "","", "","", "","", ""]
df5.to_csv(csv_output_file, mode="a", index=False, header=['Atoms','Count','Mean /A', 'Median /A','Sam. std. dev.', 'Pop. std. dev.','Std. error','Skewness'])
...
df6 = pd.DataFrame(pr_sel_angles)
df6.loc[df6.shape[0]] = ["", ""]
df6.to_csv(csv_output_file, mode="a", index=False, header=['Atoms','Angle /degrees'])
...
if args.verbose:
	...
	df7 = pd.DataFrame(summary_angle_table_1)
	df7.loc[df7.shape[0]] = ["", ""]
	df7.to_csv(csv_output_file, mode="a", index=False, header=['Atoms','Angle /degrees'])
...
df8 = pd.DataFrame(summary_angle_table_2)
df8.loc[df8.shape[0]] = ["", ""]
df8.to_csv(csv_output_file, mode="a", index=False, header=['Atoms','Angle /degrees'])
...
df9 = pd.DataFrame(summary_angle_table_3)
df9.loc[df9.shape[0]] = ["", "", "", "", "", "", "", ""]
df9.to_csv(csv_output_file, mode="a", index=False, header=['Atoms','Count','Mean /degrees', 'Median /degrees','Sam. std. dev.', 'Pop. std. dev.','Std. error','Skewness'])
...
if args.plane1:
	...
	df10 = pd.DataFrame(plane1_df)
	df10.loc[df10.shape[0]] = ["", ""]
	df10.to_csv(csv_output_file, mode="a", index=False, header=['Atom','Distance to Plane 1 /A'])
...
if args.plane2:
	...
	df11 = pd.DataFrame(plane2_df)
	df11.loc[df11.shape[0]] = ["", "", ""]
	df11.to_csv(csv_output_file, mode="a", index=False, header=['Atom','Distance to Plane 2 /A','Distance to Plane 1 /A'])
